...
const Main = () => {
  ...
  const color = ['#3D5DDF','#0FB8CE','#21A663','#FF9900','#FF5154','#D269E6','#CA93FF','#575efd','#673DD4']
  const fetchData = ()=>{
    axios.get("https://backend-youth-foundation.onrender.com/book/allbooks?limit=5").then((res)=>setData(res.data.data)).catch(err=>console.log(err))
  }
  useEffect(()=>{
    fetchData()
  })
